        ...
        for line in self:
            ...
            if line.planned_amount and line.currency_id.id != line.custom_currency_id.id:
                line.custom_planned_amount = line.currency_id._convert(
                    line.planned_amount, line.custom_currency_id, line.company_id, line.date_from or fields.Date.today())
            else:
    ...
    def _inverse_custom_planned_amount(self):
        for line in self:
            if line.custom_planned_amount and line.currency_id.id != line.custom_currency_id.id:
                line.planned_amount = line.custom_currency_id._convert(
        ...
        for line in self:
            ...
            if line.analytic_account_id.id:
                ...
                for analytic_line_id in analytic_line_ids:
                    amount_in_budget_curr += line.currency_id._convert(
                        analytic_line_id.amount, line.custom_currency_id, line.company_id, analytic_line_id.date)
            else:
                ...
                for account_move_line_id in account_move_line_ids:
                    ...
                    amount_in_budget_curr += line.currency_id._convert(
                        acc_move_line_amount, line.custom_currency_id, line.company_id, account_move_line_id.date)
        ...
        for line in self:
            if line.paid_date:
                ...
                if not line.date_from or not line.date_to:
                    line.custom_theoritical_amount = 0
                    continue
